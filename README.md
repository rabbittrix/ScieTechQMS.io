...
ScieTechQMS integrates **Guardian AI** — an on-premises intelligence layer powered by the **Mistral** language model, executed entirely on your organisation’s hardware. Proprietary formulations, batch records, investigation narratives, and audit data **never leave your facility** to reach a third-party AI provider.

From a governance perspective, this means:

- **Intellectual property remains under your control** at all times.
...
- **Regulatory confidence** is preserved: AI-assisted reviews (e.g. CAPA root-cause analysis, integrity scans) produce recommendations locally, with full human oversight retained.

Local AI supports **audit readiness** without introducing cloud-based data-integrity risk.
...
Download the latest installer from the [public releases page](https://github.com/rabbittrix/ScieTechQMS.io/releases/latest):

| Platform | Installer |
| -------- | --------- |
| Windows 10 / 11 | `ScieTechQMS_Setup.exe` |
| Linux (Ubuntu / Debian) | `ScieTechQMS.AppImage` |
...
| **Local AI (optional)** | Guardian AI requires on-premises model runtime; Mistral is provisioned locally — no cloud API key required |
